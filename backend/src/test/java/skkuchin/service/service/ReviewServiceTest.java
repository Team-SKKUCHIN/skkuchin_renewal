...
public class ReviewServiceTest extends MockTest {
    ...
    public void getAll_성공() {
        ...
        List<ReviewImage> review1Images = List.of(new ReviewImage(1L, review1, "image1"),
                new ReviewImage(2L, review1, "image2"));
    ...
    public void getDetail_성공() {
        ...
        List<ReviewImage> reviewImages = List.of(new ReviewImage(1L, review, "image1"),
                new ReviewImage(2L, review, "image2"));
    ...
    public void write_성공() throws IOException {
        ...
        ReviewDto.PostRequest dto = new ReviewDto.PostRequest(1L, 5, "굿!", List.of(image1, image2),
                List.of("맛집", "가성비"));
    ...
    public void update_성공() {
        ...
        List<ReviewTag> existingTags = List.of(new ReviewTag(1L, existingReview, tag1),
                new ReviewTag(2L, existingReview, tag2));
    ...
    public void getUserReview_성공() {
        // given
        // AppUser user2 = new AppUser(2L, "test2", "test2", "1234", "test",
        // "0000000001", null, null, null, null, null, null, null, null, null, null);
