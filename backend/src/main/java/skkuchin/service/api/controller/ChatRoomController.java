...
// public ResponseEntity<?> getRequestUser(@AuthenticationPrincipal
// PrincipalDetails principalDetails) {
// AppUser user = principalDetails.getUser();
// List<Long> requestedId = chatRoomService.getRequestUser(user);
// return new ResponseEntity<>(new CMRespDto<>(1, "요청 보낸 유저 조회 완료",
// requestedId), HttpStatus.OK);
// }

// @PostMapping("")
// @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
// public ResponseEntity<?> makeRoom(@Valid @RequestBody ChatRoomDto.RoomRequest
// dto,
...
// return new ResponseEntity<>(new CMRespDto<>(1, "밥약 신청 완료", null),
// HttpStatus.CREATED);
...
// public ResponseEntity<?> makeAdminRoom(@Valid @RequestBody
// ChatRoomDto.AdminRoomRequest dto,
// @AuthenticationPrincipal PrincipalDetails principalDetails){
// AppUser user = principalDetails.getUser();
// chatRoomService.makeAdminRoom(dto);
// return new ResponseEntity<>(new CMRespDto<>(1, "관리자 채팅방 개설 완료", null),
// HttpStatus.CREATED);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "상대방이 밥약 요청에 응답했습니다", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "상대방 채팅 차단", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 알람 설정", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 만남 장소 설정", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 만남 시간 설정", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 만남 장소 삭제 완료", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 만남 시간 삭제 완료", null),
// HttpStatus.OK);
// }
...
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅방 나가기 완료", null),
// HttpStatus.OK);
// }

// @GetMapping("/alarm")
// @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
// public ResponseEntity<?> getAlarm(@AuthenticationPrincipal PrincipalDetails
// principalDetails) {
// AppUser user = principalDetails.getUser();
// Boolean alarm =
// chatRoomService.checkUnreadMessageOrRequest(user.getUsername());
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅 알림 확인 완료", alarm),
// HttpStatus.OK);
// }

// @GetMapping("/request_list")
// @PreAuthorize("hasAnyRole('ROLE_ADMIN', 'ROLE_USER')")
// public ResponseEntity<?> getRequestlist(@AuthenticationPrincipal
// PrincipalDetails principalDetails) {
// AppUser user = principalDetails.getUser();
// List<ChatRoomDto.userResponse> requestList =
// chatRoomService.getRequestList(user.getUsername());
// return new ResponseEntity<>(new CMRespDto<>(1, "채팅 요청 목록 확인 완료",
// requestList), HttpStatus.OK);
// }
// }