...
// private void handleChangeEvent(RecordChangeEvent<SourceRecord>
// sourceRecordRecordChangeEvent) {
// SourceRecord sourceRecord = sourceRecordRecordChangeEvent.record();

// log.info("Key = '" + sourceRecord.key() + "' value = '" +
// sourceRecord.value() + "'");
...
// Operation operation = Operation.forCode((String)
// sourceRecordChangeValue.get(OPERATION));
...
// debeziumService.handleRealtimeChatRoom(roomId, operation, payload,
