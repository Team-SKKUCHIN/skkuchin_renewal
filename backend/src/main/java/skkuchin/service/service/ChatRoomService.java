...
// @Transactional
// public void user2Accept(String roomId, AppUser user, ResponseType
// responseType) {
...
// List<ChatRoom> requestedChatRooms =
// chatRoomRepo.findRequestByUserId(user.getId());
...
// chatRoom.getUser1().getId().equals(user.getId())) {
...
// chatMessageRepo.findByLatestTime(chatRoom.getRoomId());
...
// if ((chatRoom.getUser1() != null &&
// !appUser.getId().equals(chatRoom.getUser1().getId()))
// &&
...
// else if (chatRoom.getUser2() != null &&
// appUser.getId().equals(chatRoom.getUser2().getId())) {
...
// // subscription = pushTokenService.toSubscription(chatRoom.getUser1(),
// "chat");
// // } else if (
// // chatRoom.getUser2() != null
...
// // subscription = pushTokenService.toSubscription(chatRoom.getUser2(),
// "chat");
// // }
...
// private class AlarmListDateComparator implements
// Comparator<ChatRoomDto.userResponse> {
// @Override
