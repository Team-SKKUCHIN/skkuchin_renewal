...
// @Transactional
// public void handleRealtimeChatMessage(Long chatRoomId, Operation operation,
...
// ArrayList<ChatMessageDto.Response> chatMessageList = new
// ArrayList<>(chatMessages);

// if (user1 != null) {
// user1Name = user1.getUsername();
// List<ChatRoomDto.Response> chatRooms1 =
// chatRoomService.getChatRoomList(user1Name);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "room." + user1Name +
// "chatRoomList", chatRooms1);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "chat." + roomId + "user1",
// chatMessageList);
// }

// if (user2 != null) {
// user2Name = user2.getUsername();
// List<ChatRoomDto.Response> chatRooms2 =
// chatRoomService.getChatRoomList(user2Name);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "room." + user2Name +
// "chatRoomList", chatRooms2);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "chat." + roomId + "user2",
// chatMessageList);
// }

// if (operation == Operation.CREATE && !Objects.equals((String)
// payload.get("sender"), "admin")) {
...
// List<ChatRoomDto.Response> chatRooms1 =
// chatRoomService.getChatRoomList(userName1);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "room." + userName1 +
// "chatRoomList", chatRooms1);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "setting." + roomId + "user1",
// settingResponse);
// }
...
// List<ChatRoomDto.Response> chatRooms2 =
// chatRoomService.getChatRoomList(userName2);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "room." + userName2 +
// "chatRoomList", chatRooms2);
// template.convertAndSend(CHAT_EXCHANGE_NAME, "setting." + roomId + "user2",
// settingResponse);
// }
