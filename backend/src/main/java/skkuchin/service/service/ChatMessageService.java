...
// @Transactional
// public void readMessage(Long messageId, AppUser user,
// ChatMessageDto.BooleanRequest dto) {
...
// chatMessageRepo.findByChatRoom(chatRoom)
// .stream()
...
// private class MessageDateComparator implements
// Comparator<ChatMessageDto.Response> {
// @Override
...
// write(testUser, dto3);
// ChatMessageDto.Request dto4 = new ChatMessageDto.Request("그렇구나",
// chatRoomId1);
