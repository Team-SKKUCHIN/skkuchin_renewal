    ...
    return (
        <>
            <div style={{padding: '19px 0 16px', textAlign: 'center'}}>
                ...
                <Typography sx={{fontSize: '12px', color: '#777777', fontWeight: 'bold', mb: '20px', backgroundColor: '#FBFBFB', border: '2px solid #E2E2E2', borderRadius: '12px', padding: '4px 10px', width: 'max-content', margin: 'auto'}}>
                    선호 일정 : {group.date}
                </Typography>
            </div>
                ...
                <List>
                    {group.members.map((member, index) => (
                        ...
                        <ListItemText
                            ...
                            secondary={<Typography sx={{ fontSize: '16px', backgroundColor: '#FBFBFB', p: '10px 17px', border: '2px solid #E2E2E2', borderRadius: '0 8px 8px 8px', mb: '12px'}}>{member.introduction}</Typography>}
                        />
                        </ListItem>
                    ))}
                </List>
